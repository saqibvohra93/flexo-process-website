    ...
    <section id="overview" className="relative pt-28 pb-16 lg:pt-36 lg:pb-20 overflow-hidden">
      ...
      <div className="container-x relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          {/* Left: Bold, short copy */}
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-md bg-white/5 border border-white/10 text-slate-300 text-[11px] font-semibold uppercase tracking-wider mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-flexo-yellow" />
              German CDI Laser Plate Technology
            </div>
            ...
            <p className="text-base sm:text-lg text-slate-300 leading-relaxed max-w-lg mb-8">
              Pakistan's leading manufacturer of digital flexographic printing plates
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full sm:w-auto mb-10">
              ...
              <a href="tel:+922132581090" className="btn-ghost">
                <PhoneCall className="w-4 h-4 text-flexo-yellow" />
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-xs text-slate-400">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-flexo-yellow" />
                24-Hour Dispatch
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-flexo-yellow" />
                4,000 DPI Laser Precision
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-4 h-4 text-flexo-yellow" />
                Karachi S.I.T.E. Facility
              </span>
            </div>
          </div>

          {/* Right: Single strong image */}
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
              <img
                src="https://images.unsplash.com/photo-1581092160607-ee22621dd758?auto=format&fit=crop&w=1200&q=80"
                alt="Digital flexographic photopolymer printing plate close-up"
              ...
              <div className="absolute bottom-5 left-5 right-5 flex items-center justify-between bg-navy-950/85 backdrop-blur-md border border-white/10 rounded-xl px-4 py-3">
                <div>
                  <span className="text-[11px] text-slate-400 block">Plate Range</span>
                ...
                <div>
                  ...
                  <span className="text-sm font-bold text-white">Up to 200 LPI</span>
                </div>
                <div className="w-px h-8 bg-white/10" />
                <div>
                  <span className="text-[11px] text-slate-400 block">Turnaround</span>
                  <span className="text-sm font-bold text-flexo-yellow">24 Hrs</span>
                </div>
              </div>
            </div>
          </div>
