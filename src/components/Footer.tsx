...
import { Phone, Mail, MapPin, ShieldCheck, ArrowRight, ChevronRight, Award, ExternalLink } from 'lucide-react';
...
export const Footer: React.FC<FooterProps> = ({ onNavigateSection, onOpenQuote }) => {
  ...
  return (
    <footer className="bg-navy-950 border-t border-white/15 text-slate-400 text-xs">
      {/* Pre-Footer Industrial Callout Strip */}
      <div className="bg-gradient-to-r from-navy-900 via-navy-800 to-navy-900 border-b border-white/10 py-10">
        <div className="container-x flex flex-col lg:flex-row items-center justify-between gap-6 text-center lg:text-left">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <Phone className="w-4 h-4 text-flexo-yellow" />
      ...
      {/* Bottom Legal Bar */}
      <div className="border-t border-white/10 py-6 bg-navy-950/90 text-slate-400">
