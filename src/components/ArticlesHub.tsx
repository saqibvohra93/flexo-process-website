...
import { BookOpen, Search, Calendar, Clock, User, ArrowRight, X, CheckCircle2, ChevronRight, ChevronLeft, LayoutGrid, SlidersHorizontal } from 'lucide-react';
    ...
    <article className={`group rounded-xl bg-navy-900/60 border border-white/10 hover:border-flexo-yellow/40 overflow-hidden flex flex-col justify-between transition-colors duration-200 ${
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        <div>
          ...
          <h3 className="font-display font-bold text-base text-white group-hover:text-flexo-yellow transition-colors leading-snug mb-2 line-clamp-2">
            {art.title}
          </h3>
        ...
        <div className="pt-3 border-t border-white/10 flex items-center justify-between">
          ...
          <button
            ...
            className="text-xs font-bold text-flexo-yellow flex items-center gap-1 hover:underline"
          >
      ...
      <div className="container-x relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6 mb-8">
          ...
          <div className="flex items-center gap-3 shrink-0 self-start sm:self-auto">
            {viewMode === 'carousel' && (
              <div className="flex items-center gap-2 bg-navy-900/90 border border-white/10 rounded-xl p-1 shadow-sm">
                <button
                  type="button"
                  ...
                  className={`p-2 rounded-lg transition-colors ${
                    canScrollLeft
                      ? 'bg-navy-950 text-white hover:text-flexo-yellow hover:bg-white/5 border border-white/10'
        ...
        <div className="flex flex-col lg:flex-row items-stretch lg:items-center justify-between gap-4 mb-8 pb-4 border-b border-white/10">
          ...
          <div className="relative w-full lg:w-64 shrink-0">
            ...
            <input
              ...
              className="w-full bg-navy-900/90 border border-white/15 rounded-lg pl-9 pr-4 py-1.5 text-xs text-white placeholder-slate-500 focus:border-flexo-yellow focus:outline-none"
            />
          </div>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="flex items-center justify-between text-[11px] text-slate-500 mt-2 px-1">
              ...
              <span className="hidden sm:inline-flex items-center gap-1 font-mono text-slate-400">
                Use <kbd className="px-1.5 py-0.5 rounded bg-white/5 border border-white/10 text-xs">&larr;</kbd> <kbd className="px-1.5 py-0.5 rounded bg-white/5 border border-white/10 text-xs">&rarr;</kbd> arrows above
              </span>
            </div>
          </div>
        ) : (
