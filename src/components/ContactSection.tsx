...
export const ContactSection: React.FC<ContactSectionProps> = ({ prefilledData }) => {
  ...
  return (
    <section id="contact" className="py-16 lg:py-20 bg-white border-t border-slate-200 relative overflow-hidden transition-colors duration-200">
      <div className="container-x relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-6 sm:p-8 backdrop-blur-md shadow-sm">
              ...
              <div className="space-y-5 text-xs sm:text-sm">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white border border-slate-200 flex items-center justify-center text-amber-500 shrink-0 shadow-sm">
                    <MapPin className="w-5 h-5" />
                  </div>
                  <div>
                    <span className="text-slate-500 block text-xs uppercase font-mono mb-0.5">Physical Address</span>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <span className="text-slate-500 block text-xs uppercase font-mono mb-0.5">Official Emails</span>
                    <p className="text-slate-900 font-medium space-y-0.5">
            ...
            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 shadow-sm">
                <span className="font-bold text-slate-900 block mb-1">Fast Response</span>
                <span className="text-slate-500">Technical RFQs answered within 60 minutes.</span>
              </div>
              <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 shadow-sm">
                <span className="font-bold text-slate-900 block mb-1">On-Site Support</span>
                <span className="text-slate-500">Pressroom engineers stationed nationwide.</span>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 bg-white border border-slate-200 rounded-2xl p-6 sm:p-9 backdrop-blur-xl shadow-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-xs sm:text-sm text-slate-900 placeholder-slate-400 focus:border-amber-500 focus:outline-none"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-slate-900 focus:border-amber-500 focus:outline-none"
                    >
